...
// Copyright (c) 2013-2014 mec Developers
...
public:
    enum
    {
        PUBKEY_ADDRESS = 50,  // mec addresses begin with 'V'
        SCRIPT_ADDRESS = 111, // mec script addresses begin with 'Y'
...
public:
    enum
    {
        //PUBKEY_ADDRESS = 55,  // MEC: addresses begin with 'P'
        //SCRIPT_ADDRESS = 117, // MEC: addresses begin with 'p'
