...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("m-MEC");
    case uBTC: return QString::fromUtf8("μ-MEC");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("MEC");
    case mBTC: return QString("Milli-MEC (1 / 1,000)");
    case uBTC: return QString("Micro-MEC (1 / 1,000,000)");
    default: return QString("???");
    }
}
