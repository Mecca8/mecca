...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. mec can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    app.setOrganizationName("MEC");
    app.setOrganizationDomain("maijiabi.cc");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("MEC-Qt-testnet");
    else
        app.setApplicationName("MEC-Qt");
