...
const char* DistributeDivDialog::columnHeadings[] = {
    "mec Address", "Shares", "MEC Address", "Dividend"
};
...
bool DistributeDivDialog::ConfirmDistribution()
{
    ...
    {
        QMessageBox::critical(this, "Error", QString("Unable to get MEC balance: %1").arg(error.what()));
        return false;
    }
    QString sQuestion = QString("%1 MECS will be sent to %2 addresses in %3 transaction(s).\nYour current MEC balance is %4.\n\nAre you sure?").arg(
