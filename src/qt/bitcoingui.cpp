...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a mec address"));
    ...
    aboutAction->setToolTip(tr("Show information about mec"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for mec"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peershares"), tr("Show/Hide &mec"), this);
    toggleHideAction->setToolTip(tr("Show or hide the mec window"));
    ...
    exportPeercoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export MEC keys"), this);
    exportPeercoinKeysAction->setToolTip(tr("Export the MEC keys associated with the mec addresses to MEC via RPC"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("mec client"));
    ...
    notificator = new Notificator(tr("mec-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide mec"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to mec network", "", count));
}
