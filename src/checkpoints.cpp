...
//       ( 100000, uint256("0xa17dba3013fa6eede33707840a1e888e70fc335bb73407bb4ee2c5e05e1dee6b"))
    ...
    // mec: synchronized checkpoint (centrally broadcasted)
    ...
    // mec: get last synchronized checkpoint
    ...
    // mec: only descendant of current sync-checkpoint is allowed
    ...
    // mec: reset synchronized checkpoint to last hardened checkpoint
...
// mec: sync-checkpoint master key
...
// mec: verify signature of sync-checkpoint message
...
// mec: process synchronized checkpoint
